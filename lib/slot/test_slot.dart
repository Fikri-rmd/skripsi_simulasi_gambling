        ...
        content: Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text('Total Koin:', style: TextStyle(fontWeight: FontWeight.bold)),
                Text('$_coins 🪙', style: TextStyle(color: Colors.red.shade900)),
              ],
            ),
            const SizedBox(height: 10),
            Row(
            ...
            Row(
              ...
              children: [
                ...
                Text('${_spinCount ~/ 10 + 1} ⭐', style: TextStyle(color: Colors.red.shade900)),
              ],
            ),
            const SizedBox(height: 20),
            Container(
              ...
              child: const Text(
                'Fitur profil akan dikembangkan lebih lanjut pada versi berikutnya',
                style: TextStyle(fontSize: 12, color: Colors.red),
                textAlign: TextAlign.center,
              ),
            )
